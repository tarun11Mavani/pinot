...
/**
 * A {@link ForwardIndexReader} for the parent MAP column (with columnar map index) that delegates to
 ...
 * {@code RealtimeSegmentStatsContainer}) to read MAP columns with columnar map index through the standard forward
