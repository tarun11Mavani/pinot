...
public class MutableOpenStructDataSourceTest {
  ...
  /// Exercises a non-empty null bitmap through the memo, and pins the vector's own bitmap cache.
  @Test
  public void testMemoisedNullBitmapReportsAbsentDocs()
    ...
    try (MutableOpenStructIndex idx = new MutableOpenStructIndex("metrics", spec(),
      ...
      assertSame(ds.getDataSource("clicks").getNullValueVector().getNullBitmap(), nulls);
    }
  }
