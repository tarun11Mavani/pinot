...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Column {
      ...
      // Optional. The parent MAP column name for columns materialized from a MAP index.
      // If non-null, indicates this is a materialized column (no separate boolean flag needed).
      // Example: for MAP column "metrics", materialized column "metrics$country" has
