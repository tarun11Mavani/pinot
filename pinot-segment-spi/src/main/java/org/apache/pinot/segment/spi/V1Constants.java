...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Segment {
      ...
      public static final String SPARSE_MAP_COLUMNS = "segment.sparsemap.column.names";
    ...
    public static class Column {
      ...
      public static final String SPARSE_MAP_KEY_NAMES = "sparseMapKeyNames";
      public static final String SPARSE_MAP_KEY_TYPE_PREFIX = "sparseMapKeyType";
      public static final String SPARSE_MAP_DEFAULT_VALUE_TYPE = "sparseMapDefaultValueType";
